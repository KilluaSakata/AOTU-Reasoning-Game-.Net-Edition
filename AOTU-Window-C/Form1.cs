    ...
    public partial class Form1 : Form
    {
        ...
        private void 重开局ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("是否重新开局？\n" +
                "您将丢失您当前的状态与信息记录框、报告框中的内容！\n", "重新开局", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)

                RichTextBox1.Clear();
                richTextBox2.Clear();
                richTextBox2.AppendText("下面是您最终认定的凶手，请在确认无误后单击确定提交答案:\n");
        ...
        private void Button13_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("您已经选择了答案。\n" +
               "是否确认提交？提交后如果完全正确，您的信息记录框将被清空。\n", "提交确认", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)

                    if (CheckBox2.Checked == true & CheckBox5.Checked == true & CheckBox9.Checked == true & CheckBox11.Checked == true & CheckBox1.Checked == false & CheckBox3.Checked == false & CheckBox4.Checked == false & CheckBox6.Checked == false & CheckBox7.Checked == false & CheckBox8.Checked == false & CheckBox10.Checked == false & CheckBox12.Checked == false & CheckBox13.Checked == false & CheckBox14.Checked == false & CheckBox15.Checked == false & CheckBox16.Checked == false)
                    {
                        MessageBox.Show("恭喜！全部正确！您的信息记录框将被清空。\n", "结果", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        RichTextBox1.Clear();
                    }
                    else
                    {
                        if (CheckBox2.Checked == true | CheckBox5.Checked == true | CheckBox9.Checked == true | CheckBox11.Checked == true)
                        {
                            MessageBox.Show("部分正确！请查看您是否多选或漏选。\n", "结果", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        }
                        else MessageBox.Show("没有选择到正确选项！请仔细检查您的答案！\n", "结果", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
            }
            else
            {
                MessageBox.Show("您没有选择答案！\n", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void 关于CBranchToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MessageBox.Show("C# Branch是我尝试用C#语言来重新编写的这个推理小游戏。由于初学原因，也参考了不少教程与帖子，请多多理解啦QWQ\n" +
                            "V1.1:1.修复了当用户选择结果为部分正确时，不弹出“部分正确”的提示窗口。2.增加没有选择答案时的错误提示。3.更正一点错字。4.增加选中嫌疑人提示框。已知Bug:因为取消复选框时调用的是Undo函数，所以若不按提示框上面的顺序撤回，很容易出现提示框中名字的显示错误(技术有限)。为了解决此类尴尬，特添加了清空报告按钮。下个版本中将不把该现象列为Bug。\n" +
                            "V1.0:初版 Core版本 V1.5，由VB语言移植到C#语言。已知Bug:在用户的最终结果为部分正确时，不显示对话框。\n", "关于 C# Branch", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void CheckBox1_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox1.Text + "\n");
            }
        ...
        private void CheckBox2_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox2.Text + "\n");
            }
        ...
        private void CheckBox3_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox3.Text + "\n");
            }
        ...
        private void CheckBox13_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox13.Text + "\n");
            }
        ...
        private void CheckBox10_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox10.Text + "\n");
            }
        ...
        private void CheckBox11_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox11.Text + "\n");
            }
        ...
        private void CheckBox4_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox4.Text + "\n");
            }
        ...
        private void CheckBox14_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox14.Text + "\n");
            }
        ...
        private void CheckBox5_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox5.Text + "\n");
            }
        ...
        private void CheckBox15_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox15.Text + "\n");
            }
        ...
        private void CheckBox6_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox6.Text + "\n");
            }
        ...
        private void CheckBox7_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox7.Text + "\n");
            }
        ...
        private void CheckBox9_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox9.Text + "\n");
            }
        ...
        private void CheckBox12_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox12.Text + "\n");
            }
        ...
        private void CheckBox8_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox8.Text + "\n");
            }
        ...
        private void CheckBox16_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                richTextBox2.AppendText(CheckBox16.Text + "\n");
            }
        ...
        {
            if (MessageBox.Show("确定要清空报告框吗？\n", "清空报告框", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                richTextBox2.Clear();
                richTextBox2.AppendText("下面是您最终认定的凶手，请在确认无误后单击确定提交答案:\n");
        }
    }
